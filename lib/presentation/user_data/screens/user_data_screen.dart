        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              _buildTextField('Cédula', userData.cc, isEditing,
                  (value) => userDataNotifier.updateField('cc', value)),
              const SizedBox(height: 20),
              _buildTextField('EPS', userData.eps, isEditing,
                  (value) => userDataNotifier.updateField('eps', value)),
              const SizedBox(height: 20),
              _buildTextField('ARL', userData.arl, isEditing,
                  (value) => userDataNotifier.updateField('arl', value)),
              const SizedBox(height: 20),
              _buildTextField('AFP', userData.afp, isEditing,
                  (value) => userDataNotifier.updateField('afp', value)),
              const SizedBox(height: 20),
              _buildTextField('Nombre del Contacto de Emergencia', userData.emergencyContactName, isEditing,
                  (value) => userDataNotifier.updateField('emergencyContactName', value)),
              const SizedBox(height: 20),
              _buildTextField('Teléfono del Contacto de Emergencia', userData.emergencyContactPhone, isEditing,
                  (value) => userDataNotifier.updateField('emergencyContactPhone', value)),
              const SizedBox(height: 20),
              _buildTextField('Parentesco', userData.relationship, isEditing,
                  (value) => userDataNotifier.updateField('relationship', value)),
              const SizedBox(height: 20),
              _buildTextField('Dirección', userData.address, isEditing,
                  (value) => userDataNotifier.updateField('address', value)),
              const SizedBox(height: 20),
              SignatureWidget(
